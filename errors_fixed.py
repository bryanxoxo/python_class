###########################################################
# The first section lists all the functions I'm going to be using in this challenge
###########################################################



# This method breaks up text into words for us
def break_the_words(text):
    words = text.split()
    return words
...
###########################################################
#Below is the actual code that is being run using the functions
###########################################################
